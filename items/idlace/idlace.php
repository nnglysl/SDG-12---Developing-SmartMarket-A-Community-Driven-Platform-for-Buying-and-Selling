...
<head>
    ...
    <title>ID Lace Product Page</title>
            ...
            <section class="product-details">
                ...
                <div class="product-info">
                    ...
                    <form id="addToCartForm" method="POST" action="">
                        ...
                        <input type="hidden" name="product_name" value="ID Lace">
                        <input type="hidden" name="product_price" value="50">
                        <input type="hidden" id="selectedSizeInput" name="selected_size" value="">
                        <input type="hidden" name="product_image" value="/final/imgs/school supplies/idlace.jpg">
