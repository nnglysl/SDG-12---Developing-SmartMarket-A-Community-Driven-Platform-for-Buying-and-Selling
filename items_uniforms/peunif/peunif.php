...
<head>
    ...
    <title>PE Uniform Product Page</title>
    <link rel="stylesheet" href="/final/items_uniforms/peunif/peunif.css" />
    ...
    <main class="product-page">
        <div class="center-container">
            ...
            <section class="product-details">
                <div class="product-image-gallery">
                    <div class="main-image">
                        <img id="mainImage1" class="slider-image active" src="/final/imgs/uniforms/peunif.png"
                            alt="Product Image" />
                    </div>
                </div>

                <div class="product-info">
                    <h1 class="product-title">Preloved PE Uniform Set</h1>
                    <p class="product-price" id="productPrice">₱ 400.00</p>

                    <form id="addToCartForm" method="POST" action="">
                        <input type="hidden" name="product_id" value="<?= $product_id; ?>">
                        <input type="hidden" name="product_name" value="Preloved PE Uniform Set">
                        <input type="hidden" name="product_price" value="400">
                        <input type="hidden" name="product_image" value="/final/imgs/uniforms/peunif.png">
            ...
            <section class="product-description">
                ...
                <p>
                    This preloved PE uniform set is perfect for school activities and sports. Made from high-quality materials, it ensures comfort and durability. Available in various sizes, this set is a great addition to your child's wardrobe.
                </p>
                <p>
                    Size: Small
                </p>
