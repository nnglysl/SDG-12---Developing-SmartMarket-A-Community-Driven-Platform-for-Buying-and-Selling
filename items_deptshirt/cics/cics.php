...
<head>
  ...
  <title>CICS Product Page</title>
  <link rel="stylesheet" href="/final/items_deptshirt/cics/cics.css" />
      ...
      <section class="product-details">
        <div class="product-image-gallery">
          <div class="main-image">
            <img id="mainImage1" class="slider-image active" src="/final/imgs/department shirts/cics.png"
              alt="Product Image" />
          </div>
        </div>
        ...
        <div class="product-info">
          <h1 class="product-title">CICS Department Shirt</h1>
          ...
          <form id="addToCartForm" method="POST" action="">
            ...
            <input type="hidden" name="product_image" value="/final/imgs/department shirts/cics.png">
